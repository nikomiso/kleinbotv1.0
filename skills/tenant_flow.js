...
module.exports = function (controller) {
    ...
    controller.hears('tenant', 'message_received', function (bot, message) {
        var propertiesArray = [];
        var isAreaFlag;
        var minPriceDb;
        var maxPriceDb;
                                    ...
                                    convo.ask('Also, please set the lowest price.', function (response, convo) {
                                        ...
                                        if (!isNaN(lowestPrice)) {
                                            ...
                                            if ((highestPrice >= minPriceDb) && (lowestPrice <= maxPriceDb) && (highestPrice>=lowestPrice)) {
                                                ...
                                                connection.query("SELECT STREET, STREET_NUMBER, PRICE, SIZE, AREA FROM PROPERTIES JOIN RENT ON\
